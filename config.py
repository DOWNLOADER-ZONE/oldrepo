...
OWNER_ID = [5696438657 , 1714725355 , 7202724594]
OWNER_IDS = [5696438657 , 1714725355 , 7202724594]
...
LOG_GROUP = getenv("LOG_GROUP", "-1002613698789")
CHANNEL_ID = int(getenv("CHANNEL_ID", "-1002613698789"))
